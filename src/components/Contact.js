...
const Contact = () => {
  return (
    <section id="contact" className="pt-32 pb-36">
      <div className="container">
        <div className="w-full px-4">
          <div className="max-w-xl mx-auto text-center mb-16">
            ...
            <p className="font-medium text-md text-secondary md:text-lg">Lorem ipsum dolor, sit amet consectetur adipisicing elit. A, rerum.</p>
          </div>
        </div>
        <form>
          <div className="w-full lg:w-2/3 lg:mx-auto">
            ...
            <div className="w-full mb-8 px-4">
              ...
              <textarea type="text" id="message" className="w-full h-32 bg-slate-200 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary"></textarea>
            </div>
            <div className="w-full px-4">
